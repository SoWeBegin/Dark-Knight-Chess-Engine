/* ORIGINAL FILE FROM https://github.com/dshawul/nnue-probe
(Thanks to DSHAWUL on GitHub for making this piece of heaven possible!)
*/
    ...
    int* fifty, int* move_number, int* piece, int* square)
{
    ...
    *castle = 0;
    ...
    if (*p && *(p + 1) && isdigit(*p) && (isdigit(*(p + 1)) || *(p + 1) == ' ')) {
        sscanf_s(p, "%d %d", fifty, move_number);
